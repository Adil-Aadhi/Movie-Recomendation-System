...
function HomeCard(){
    ...
    const [telung,setTelung]=useState([])
  ...
  { name: "Horror", id: 27 },
    ...
    const MalayalamMovies=async()=>{
        ...
        try{
            const res=await axios.get(`${movies}&with_original_language=ml&primary_release_year=2025`)
    ...
    const TamilMovies=async()=>{
        ...
        try{
            const res=await axios.get(`${movies}&with_original_language=ta&primary_release_year=2025`)
    ...
    const EnglishMovies=async()=>{
        ...
        try{
            const res=await axios.get(`${movies}&with_original_language=en`)
    ...
    const HindiMovies=async()=>{
        ...
        try{
            const res=await axios.get(`${movies}&with_original_language=hi`)
    ...
    const TelungMovies=async()=>{

        try{
            const res=await axios.get(`${movies}&with_original_language=te&primary_release_year=2025`)
            setTelung(res.data.results);
        }
        catch(e){
            console.log("Error on fetching movies")
        }
    ...
    return(    
            ...
            <h2 className="text-3xl font-bold text-white mb-8 text-center">Popular Malayalam Movies</h2>
            
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6 mb-7">
                {malayalam.filter(movie => movie.poster_path)
                .slice(0,6)
                    .map((movie, index) => (
                <div 
                    key={movie.id} 
            ...
            <h2 className="text-3xl font-bold text-white mb-8 text-center">Popular Tamil Movies</h2>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6 mb-7">
                {Tamil.slice(0,6)
                    .map((movie, index) => (
                <div 
             ...
             <div className="flex justify-end items-center">
                <button className="flex items-center hover:bg-red-500 p-2 gap-1 rounded-xl cursor-pointer transition-all duration-400 ease-in-out" onClick={()=>navigate('/moremovies?lang=ta')}>
                    <span className="font-medium">More</span><IoIosArrowForward className="text-xl"/></button>
            </div>
            <h2 className="text-3xl font-bold text-white mb-8 text-center">Popular English Movies</h2>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6 mb-7">
                {English.slice(0,6)
                    .map((movie, index) => (
                <div 
             ...
             <div className="flex justify-end items-center">
                <button className="flex items-center hover:bg-red-500 p-2 gap-1 rounded-xl cursor-pointer transition-all duration-400 ease-in-out"  onClick={()=>navigate('/moremovies?lang=en')}>
                    <span className="font-medium">More</span><IoIosArrowForward className="text-xl"/></button>
            </div>
            <h2 className="text-3xl font-bold text-white mb-8 text-center">Popular Hindi Movies</h2>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6 mb-7">
                {Hindi.slice(0,6)
                    .map((movie, index) => (
                <div 
             ...
             <div className="flex justify-end items-center">
                <button className="flex items-center hover:bg-red-500 p-2 gap-1 rounded-xl cursor-pointer transition-all duration-400 ease-in-out" onClick={()=>navigate('/moremovies?lang=hi')}>
                    <span className="font-medium">More</span><IoIosArrowForward className="text-xl"/></button>
            </div>
            <h2 className="text-3xl font-bold text-white mb-8 text-center">Popular Telung Movies</h2>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6 mb-7">
                {telung.slice(0,6)
                    .map((movie, index) => (
                <div 
             ...
             <div className="flex justify-end items-center">
                <button className="flex items-center hover:bg-red-500 p-2 gap-1 rounded-xl cursor-pointer transition-all duration-400 ease-in-out" onClick={()=>navigate('/moremovies?lang=te')}>
                    <span className="font-medium">More</span><IoIosArrowForward className="text-xl"/></button>
            </div>
            </div>
    )
